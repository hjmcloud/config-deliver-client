...
DOCKER_NAME = "config-deliver-client"
...
bin.publish:
	...
	git push -f git@gitee.com:hjmcloud/config-deliver-client-release.git master;\
	echo "$(shell date +'%Y-%m-%d %H:%M:%S')|完成到gitee部署";\
	open -a "/Applications/Safari.app" https://gitee.com/hjmcloud/config-deliver-client-release/pages;
